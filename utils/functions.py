...
food_drink = ["Delicious pizza with all the toppings, realistic style, savory mood", "Mouth-watering sushi rolls, watercolor style, fresh mood", "Tasty cupcake with frosting, sketch style, sweet mood", "Juicy hamburger with fries, pop art style, indulgent mood", "Refreshing fruit smoothie, pastel style, healthy mood", "Spicy bowl of noodles, abstract style, bold mood", "Icy margarita in a tropical setting, neon style, relaxed mood", "Crispy fried chicken, photorealistic style, satisfying mood", "Rich cup of coffee, minimalist style, energized mood", "Sweet bowl of ice cream with sprinkles, oil painting style, happy mood"]
