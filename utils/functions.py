...
def generate_images(image_description, n_variations):
    ...
    try:
        ...
        error_field2.error("Error: An error occurred. Please try again.")
        spinner.empty()
        return None
        ...
        st.session_state.error_indicator = True
        error_field2.error("Error: Your request was rejected by the safety system. Please amend your input and try again.")
        spinner.empty()
        return None
