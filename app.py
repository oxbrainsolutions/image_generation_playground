...
with dataset_container:
  ...
  st.session_state.user_image_description = st.text_area(label="", label_visibility="collapsed", placeholder="Enter Description", height=500, key="key1", on_change=change_callback1)
