...
with st.sidebar:
    sidebar_header_text = '<p class="text" style="margin-top: -5em; margin-bottom: 0em; text-align: justify; line-height: 0.5;"><span style="font-family:sans-serif; color:#FAFAFA; font-size: 0.6em; ">DISCLAIMER: The image synthesis and generation capabilities provided in the playground are facilitated through advanced machine learning technology developed by OpenAI. This playground may exhibit inherent limitations associated with the accuracy of generated images and is intended for educational purposes only.</p></span></p>'
